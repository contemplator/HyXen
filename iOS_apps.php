                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li class="active"><a href="iOS_apps.php">多支APP比較</a></li>
                ...
                <div class="panel-body">
                    <table class="table table-striped">
                        <tr>
                            ...
                            <td><nav><input type="checkbox" id="allapp" value="all" onchange="chooseAll('app')">全部&nbsp&nbsp</nav><?php
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="radio" name="period" value="daily" onchange="updatePeriod('daily', 'iOS')">日&nbsp
                                <input type="radio" name="period" value="weekly" onchange="updatePeriod('weekly', 'iOS')">週&nbsp
                                <input type="radio" name="period" value="monthly" onchange="updatePeriod('monthly', 'iOS')">月&nbsp
                                <input type="radio" name="period" value="year" onchange="updatePeriod('year', 'iOS')">年&nbsp
                            </td>
                        </tr>
                    </table>
                    ...
                    <table id="data_div" class ="table table-hover container_12">
                        <tr><td>App name</td><td>Date</td><td>每日下載量</td></tr>
